print ("loaded mid forces by m1pk on github")

local CoreGui = game:GetService("StarterGui")

CoreGui:SetCore("SendNotification", {
    Title = "mid forces";
    Text = "thanks for using one of the only unpatched scripts";
    Duration = 5;
    Button1 = "woa cool";
    Button2 = "fuck off";
})
...
local w = library:CreateWindow('mid forces')

w:Section('Visuals')
local b = w:Button("Chams + Distance", function()
   loadstring(game:HttpGet("https://pastehub.net/raw.php?p=f51adc3eb0c", true))() --//esp
end)

local b = w:Button("Dropped Weapons ESP", function()
...
local b = w:Button("Grenade ESP", function()
   local Holder = {};
...
local b = w:Button("Third Person (L)", function()
    -- Services
...
local b = w:Button("Aimbot", function()
...
local b = w:Button("Grenade Aimbot", function()
